...
@pytest.mark.parametrize('prices, tax_rate, expected', [([100, 200, 300], 10, [110, 220, 330]),
                                                        ([1000, 2000, 3000], 50, [1500, 3000, 4500])])
def test_on_params(prices, tax_rate, expected):
